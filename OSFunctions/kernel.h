...
extern int mymem_count_alloc;  /**< define mymem_count_alloc Variable to see allocated memory . */ 
extern int mymem_count_free;   /**< define mymem_count_free Variable to see free memory . */ 
#endif
#pragma once
